 ...
 */
function template_clsearch_above()
{
	global $context, $scripturl, $txt;

	$extra = '
	<form id="mlsearch" action="' . $scripturl . '?action=characterlist;sa=search" method="post" accept-charset="UTF-8">
		<ul class="floatright">
			<li>
 ...
 */
function template_characterlist()
{
	global $context, $txt;
	...
	{
		foreach ($context['characters'] as $member)
		{
 ...
 */
function template_clsearch_below()
{
